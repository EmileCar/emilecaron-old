            ...
            <div className="section-general">
                ...
                <div className="section__content">
                    <div className="about__container">
                        ...
                        <AboutItem title={t("about.exchange.title")} description={t("about.exchange.description")} img={"assets/images/exchange.jpg"}/>
                        <AboutItem title={t("about.highschool.title")} description={t("about.highschool.description")} img={"assets/images/highschool.jpg"}/>
